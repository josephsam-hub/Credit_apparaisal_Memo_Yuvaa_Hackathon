...
if __name__ == "__main__":
    pass
def extract_financials_with_llm(raw_text, llm):
    """
    Extract financial metrics from raw PDF text using LLM
    """

    prompt = f"""
Extract financial metrics from the following Indian financial document.
Return ONLY JSON.
